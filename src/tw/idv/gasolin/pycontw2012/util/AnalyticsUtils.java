...
public class AnalyticsUtils {
    ...
    private static final String UACODE = Pref.UACODE;
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                try {
                    ...
                    Log.d(TAG, "coscup Analytics trackEvent: " + category
                        + " / " + action + " / " + label + " / " + value);
                } catch ( Exception e ) {
                    // We don't want to crash if there's an Analytics library
                    // exception.
                    Log.w(TAG, "coscup Analytics trackEvent error: "
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                try {
                    ...
                    Log.d(TAG, "coscup Analytics trackPageView: " + path);
                } catch ( Exception e ) {
                    // We don't want to crash if there's an Analytics library
                    // exception.
                    Log.w(TAG,
                        "coscup Analytics trackPageView error: " + path, e);
                }
                return null;
            }
        }.execute();
