...
public class UIUtils {
     ...
     */
    public static final TimeZone CONFERENCE_TIME_ZONE = TimeZone.getTimeZone("Asia/Taipei");

//    public static final long CONFERENCE_START_MILLIS = ParserUtils.parseTime("2011-09-15T09:00:00.000+08:00");
//    public static final long CONFERENCE_END_MILLIS = ParserUtils.parseTime("2012-01-20T17:30:00.000+08:00");

//    public static final Uri CONFERENCE_URL = Uri.parse("http://www.google.com/events/io/2011/");

    /** Flags used with {@link DateUtils#formatDateRange}. */
    private static final int TIME_FLAGS = DateUtils.FORMAT_SHOW_DATE | DateUtils.FORMAT_SHOW_TIME
...
//            && currentTimeMillis < CONFERENCE_END_MILLIS ) {
    ...
    public static String getBestLocaleString(Locale locale, String en,
        String zhTw, String zhCn) {
        String result = null;
    ...
    /*
     * public static Class getMapActivityClass(Context context) { if
     * (UIUtils.isHoneycombTablet(context)) { return MapMultiPaneActivity.class;
     * }
     * 
