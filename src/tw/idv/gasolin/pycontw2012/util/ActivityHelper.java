...
import tw.idv.gasolin.pycontw2012.ui.HomeActivity;
...
public class ActivityHelper {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        mActivity.getMenuInflater()
            .inflate(R.menu.default_menu_items, menu);
        return false;
    }
     ...
     * {@link tw.idv.gasolin.pycontw2012.ui.HomeActivity}.
     */
    public void goHome() {
    ...
    public void setupActionBar(CharSequence title, int color) {
        ...
        if ( title != null ) {
            ...
            // Add logo
            ImageButton logo = new ImageButton(
                mActivity,
                null,
    ...
    private View addActionButtonCompat(int iconResId, int textResId,
        ...
        actionButton.setContentDescription(mActivity.getResources()
            .getString(textResId));
