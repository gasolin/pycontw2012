...
public class BlocksLayout extends ViewGroup {
    ...
    private static final String LOG_TAG = BlocksLayout.class.getSimpleName();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(resolveSize(width, widthMeasureSpec), resolveSize(
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for ( int i = 0; i < count; i++ ) {
            ...
            if ( child instanceof BlockView ) {
                ...
                final int maxSubcols = blockView.getMaxSubColumns();
                final int subColWidth = columnWidth / maxSubcols;

                final int left = headerWidth
                    + ( blockView.getColumn() * columnWidth )
                    + ( blockView.getSubColumn() * subColWidth );
                final int right = left + subColWidth;
