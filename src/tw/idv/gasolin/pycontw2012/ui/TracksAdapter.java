...
public class TracksAdapter extends CursorAdapter {
        ...
        if ( mHasAllItem && position == 0 ) {
            ...
            ( (TextView) convertView.findViewById(android.R.id.text1) ).setText("("
                + mActivity.getResources()
                    .getString(R.string.all_sessions_title) + ")");
            convertView.findViewById(android.R.id.icon1)
    ...
    public interface TracksQuery {
        ...
        String[] PROJECTION = { BaseColumns._ID,
            CoscupContract.Tracks.TRACK_ID, CoscupContract.Tracks.TRACK_NAME,
            CoscupContract.Tracks.TRACK_ABSTRACT,
        ...
        String[] PROJECTION_WITH_SESSIONS_COUNT = { BaseColumns._ID,
            ...
            CoscupContract.Tracks.TRACK_ABSTRACT,
            CoscupContract.Tracks.TRACK_COLOR,
            CoscupContract.Tracks.SESSIONS_COUNT, };
