...
import tw.idv.gasolin.pycontw2012.ui.SessionDetailFragment;
import tw.idv.gasolin.pycontw2012.ui.SessionsFragment;
import tw.idv.gasolin.pycontw2012.ui.phone.SessionDetailActivity;
import tw.idv.gasolin.pycontw2012.ui.phone.SessionsActivity;
...
public class ScheduleMultiPaneActivity extends BaseMultiPaneActivity implements
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        if ( detailContainer != null && detailContainer.getChildCount() > 0 ) {
            findViewById(R.id.fragment_container_schedule_detail).setBackgroundColor(
                0);
        }
    }
    ...
    public FragmentReplaceInfo onSubstituteFragmentForActivityLaunch(
        ...
        if ( SessionsActivity.class.getName()
        ...
        } else if ( SessionDetailActivity.class.getName()
            .equals(activityClassName) ) {
            findViewById(R.id.fragment_container_schedule_detail).setBackgroundColor(
                0);
            return new FragmentReplaceInfo(
