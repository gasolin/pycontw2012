...
import tw.idv.gasolin.pycontw2012.ui.tablet.NowPlayingMultiPaneActivity;
...
//        if ( currentTimeMillis < UIUtils.CONFERENCE_START_MILLIS ) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    ...
                    AnalyticsUtils.getInstance(getActivity())
                        .trackEvent("Home Screen Dashboard", "Click",
                            "Realtime Stream", 0);
    ...
    private void setupAfter() {
        ...
        getActivity().getLayoutInflater()
            .inflate(R.layout.whats_on_thank_you, mRootView, true);
    }

    private void setupDuring() {
        // Conference in progress, show "Now Playing" link.
        View view = getActivity().getLayoutInflater()
            .inflate(R.layout.whats_on_now_playing, mRootView, false);
        view.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if ( UIUtils.isHoneycombTablet(getActivity()) ) {
