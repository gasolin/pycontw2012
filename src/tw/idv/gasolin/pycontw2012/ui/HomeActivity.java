...
import tw.idv.gasolin.pycontw2012.service.SyncService;
import tw.idv.gasolin.pycontw2012.util.AnalyticsUtils;
import tw.idv.gasolin.pycontw2012.util.DetachableResultReceiver;
...
public class HomeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDashboardFragment = (DashboardFragment) fm.findFragmentById(R.id.fragment_dashboard);
        ...
        if ( mSyncStatusUpdaterFragment == null ) {
            ...
            fm.beginTransaction()
                .add(mSyncStatusUpdaterFragment, SyncStatusUpdaterFragment.TAG)
                .commit();
        }
    }
    ...
    public void onBackPressed() {
        if ( mTagStreamFragment == null || !mTagStreamFragment.onBackPressed() ) {
            super.onBackPressed();
        }
    }
    ...
    private void triggerRefresh() {
        ...
        Log.d(TAG, "triggerRefresh: " + mSyncStatusUpdaterFragment.mReceiver);
    ...
    private void updateRefreshStatus(boolean refreshing) {
        // mDashboardFragment.setScheduleButtonEnabled(refreshing);
    ...
    public static class SyncStatusUpdaterFragment extends Fragment implements
        ...
        public void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            Log.d(TAG, "onReceiveResult: " + resultCode + ", activity: "
                + activity);
