...
//    private static final Pattern sSiteUrlPattern = Pattern.compile("google\\.com\\/gwt\\/x");
//    private static final Pattern sSiteUrlPatternTablet = Pattern.compile("blog\\.coscup\\.org");
//    private static final String BULLETIN_URL = "http://www.google.com/gwt/x?u=http%3A%2F%2Fblog.coscup.org%2F&btnGo=Go&source=wax&ie=UTF-8&oe=UTF-8";
//    private static final String BULLETIN_URL_TABLET = "http://blog.coscup.org/";
...
//            Pattern pattern = UIUtils.isTablet(view.getContext())
//                ? sSiteUrlPatternTablet : sSiteUrlPattern;
        	Pattern pattern = Pattern.compile(getString(R.string.bulletin_pattern));
